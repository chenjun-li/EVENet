...
class EVENetCNNBase(nn.Module):
    ...
    * Loss Function (weighted Cross-Entropy and dice loss)
    ...
    def __init__(self, params, padded_size=256):
        super(EVENetCNNBase, self).__init__()
...
class EVENetCNN(EVENetCNNBase):
    def __init__(self, params, padded_size):
        super(EVENetCNN, self).__init__(params)
        params['num_channels'] = params['num_filters']
    ...
    def forward(self, x, scale_factor=None, scale_factor_out=None):
        ...
        output = net_out  # Evidential: without classifier
        return output


class EvidentialCNN(EVENetCNNBase):
    def __init__(self, params, padded_size):
        super(EVENetCNN, self).__init__(params)
        params['num_channels'] = params['num_filters']
        self.classifier = sm.ClassifierBlock(params)
...
class EVENetVINN(EVENetCNNBase):
    """
    ...
    * Loss Function (weighted Cross-Entropy and dice loss)
    ...
    def __init__(self, params, padded_size=256):
        ...
        super(EVENetVINN, self).__init__(params)
...
class EvidentialCNN_old(EVENetCNNBase):
    def __init__(self, params, padded_size):
        super(EvidentialCNN, self).__init__(params)
        params['num_channels'] = params['num_filters']
        self.classifier = sm.ClassifierBlock(params)
        self.classes = params['num_classes']
    ...
    def forward(self, x, scale_factor=None, scale_factor_out=None):
        ...
        output = self.classifier.forward(net_out)
        # evidence = self.infer(output) # batch_size * class * image_size
...
_MODELS = {
    "EVENetCNN": EVENetCNN,
    "EVENetVINN": EVENetVINN,
    "EvidentialCNN": EVENetCNN,
    "SwinUNETR": SwinUNETR
}
...
def build_model(cfg):
    ...
    if cfg.MODEL.MODEL_NAME == "SwinUNETR":
        # model = SwinUNETR(img_size=(320,320,20), in_channels=1, out_channels=1, feature_size=24)
        model = SwinUNETR(img_size=(320, 320), in_channels=7, out_channels=90, use_checkpoint=True, spatial_dims=2)
        # model = SwinUNETR(img_size=(320,320), in_channels=13, out_channels=1, use_checkpoint=True, spatial_dims=2)
    else:
